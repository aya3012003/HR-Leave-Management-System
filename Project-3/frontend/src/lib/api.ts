...
const BASE_URL = (import.meta.env.VITE_API_BASE_URL ?? 'http://localhost:7000').replace(/\/$/, '');
...
export const dashboardApi = {
  getStats: () =>
    request<DashboardStatisticsDto>('/api/Dashboard'),
...
export const departmentsApi = {
  getAll: () =>
    request<DepartmentDto[]>('/api/Department'),
...
export const leaveRequestsApi = {
  ...
  getMy: () =>
    request<LeaveRequestDto[]>('/api/v1/LeaveRequests/my'),
