  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof TypeError && err.message.includes('fetch')) {
        setError("Cannot reach the server. Check that your backend is running and VITE_API_BASE_URL is correct.");
      } else {
        setError(err?.data?.message || err.statusText || err.message || "Failed to login. Please check your credentials.");
      }
    } finally {
      setIsLoading(false);
    }
