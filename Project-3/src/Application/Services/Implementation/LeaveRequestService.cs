...
namespace Project_3.src.Application.Services.Implementation
{
    public class LeaveRequestService : ILeaveRequestService
    {
        ...
        public async Task<LeaveRequestDto> CreateAsync(string userId, CreateLeaveRequestDto dto)
        {
            ...
            if (hasOverlap)
                throw new ValidationException("You already have an active leave request during this period.");
            ...
            // Deduct balance IMMEDIATELY to prevent "Double Spend" bugs
            balance.RemainingDays -= workingDays;
        ...
        public async Task<LeaveRequestDto> ApproveAsync(int id, string managerId, LeaveRequestActionDto dto)
        {
            ...
            //Removed balance deduction from here, as it is now handled in CreateAsync
        ...
        public async Task<LeaveRequestDto> RejectAsync(int id, string managerId, LeaveRequestActionDto dto)
        {
            ...
            // Refund the days back to the employee's balance
        ...
        public async Task<LeaveRequestDto> CancelAsync(int id, string userId)
        {
            ...
            // Always refund the balance since it was deducted during CreateAsync
        ...
        private async Task ValidateManagerDepartmentAccess(string managerId, int? employeeDeptId)
        {
            ...
            {
                //Added null check for unassigned employees or unassigned managers
                if (manager?.DepartmentId == null || manager.DepartmentId != employeeDeptId)
                    throw new UnauthorizedAccessException("You can only review requests for your own department. This employee may be unassigned or belong to another department.");
            }
        }
    }
}
